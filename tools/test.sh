...
COMMANDS=(
    ...
    "memtest"
    "libctest"
    "cd /bin && echo c?t *grep* && cd /"
    "forktest"
    "sigtest"
    "edit /mnt/muharrir.txt"
    $'MyOS muharriri ishlaydi\x13\x11'
    "cat /mnt/muharrir.txt"
    "spin cheksiz 1000"
    "@kut:\\[cheksiz\\] 3/1000"
    $'\x03'
    "echo ctrl-c holati=\$?"
...
EXPECT=(
    ...
    "libctest: PASSED|libctest: libc (string, strtoul, gmtime, snprintf, qsort, malloc)"
    "^cat grep$|glob: shell'da * va ? naqshlari"
    ...
    "^MyOS muharriri ishlaydi$|matn muharriri (xom rejim, ANSI) faylni diskka saqladi"
